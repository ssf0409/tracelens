...
Requires the `http` optional dependency: pip install tracelens[http]
"""
...
def _require_httpx() -> Any:
    """Import httpx only when the HTTP adapter is actually used."""
    try:
        import httpx
    except ImportError as exc:
        raise ImportError(_HTTPX_REQUIRED_MESSAGE) from exc
    return httpx
