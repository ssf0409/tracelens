...
If TraceLens fits, the fastest path is [Getting Started (5 min)](getting-started.md).
If you'd rather understand the moving parts first, read
[Core Concepts & Glossary](concepts.md).
